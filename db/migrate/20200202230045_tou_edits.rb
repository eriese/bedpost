class TouEdits < Mongoid::Migration
	TERM = <<-TERM
<div>
	<h2>AGREEMENT TO TERMS</h2>
	<p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and BedPost App ("Company", “we”, “us”, or “our”), concerning your access to and use of the https://bedpost.me website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
	<p>Supplemental terms and conditions or documents that may be posted on the Site from time to time are hereby expressly incorporated herein by reference. We reserve the right, in our sole discretion, to make changes or modifications to these Terms of Use at any time and for any reason. We will alert you about any changes by updating the “Last updated” date of these Terms of Use and prompting you to review them upon sign in. It is your responsibility to periodically review these Terms of Use to stay informed of updates. You will be subject to, and will be deemed to have been made aware of and to have accepted, the changes in any revised Terms of Use by your continued use of the Site after the date such revised Terms of Use are posted.</p>
...
<div>
	<h2>DISCLAIMER</h2>
	<p>The BedPost App website and app is intended for informational, educational, and research purposes only. It is not, and it is not intended to be: medical advice, used in the diagnosis of disease, infection or other conditions, or in the cure, mitigation, treatment, or prevention of disease or infection in humans or other animals. Always consult your doctor for medical advice.</p>
</div>
<div>
...
<div>
	...
	<p id="prohibitions">As a user of the Site, you agree not to:</p>
	<ol aria-describedby="prohibitions">
...
<div>
	...
	<ol aria-describedby="contributions">
		...
		<li>Your Contributions are not violent, harassing, libelous, slanderous, or otherwise objectionable (as determined by us).</li>
		...
		<li>Your Contributions do not include any offensive comments that are connected to race, national origin, gender, sexual orientation, or disability.</li>
...
<div>
	...
	<p>
		BedPost App <br>
		Phone: <a class="link" href="tel:5127663839">512 766 3839</a> <br>
		<a class="link" href="mailto:support@bedpost.me">support@bedpost.me</a>
	</p>
</div>
TERM

	def self.up
		Terms.create(type: :tou, terms: TERM)
		UserProfile.with_session do |session|
			UserProfile.each do |u|
				u.accept_terms(:tou) if u.terms && u.terms[:tou].present?
			end
		end
	end

	def self.down
		Terms.where(type: :tou, terms: TERM).destroy_all
	end
end
