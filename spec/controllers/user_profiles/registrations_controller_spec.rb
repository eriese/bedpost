...
RSpec.describe UserProfiles::RegistrationsController, type: :controller do
	...
	describe 'PUT #update' do
		...
		context 'with valid password' do
			...
			it 'updates the password' do
				...
				pms = { user_profile: { current_password: attributes_for(:user_profile)[:password], password: new_password,
		...
		context 'with no password' do
			it 'updates non-protected fields' do
				pms = { user_profile: { external_name: 'new name', email: @user.email, password: '', current_password: '',
			...
			it 'responds with a submission error if a protected field is changed' do
				pms = { user_profile: { external_name: 'new name', email: 'newemail@mail.com', password: '', current_password: '',
																												password_confirmation: '' } }
				put :update, params: pms, format: :json
	...
	describe 'DELETE #destroy' do
		...
		it 'calls #soft_destroy on the user if the password is correct' do
			...
			delete :destroy, params: { account_delete: { current_password: attributes_for(:user_profile)[:password] } },
																				format: :json
