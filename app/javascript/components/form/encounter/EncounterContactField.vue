...
<div class="contact-field-container" :class="{blurred: !focused, invalid: incomplete}">
	<div v-if="incomplete" class="contact-error" aria-live="polite">{{$_t('mongoid.errors.models.contact.incomplete')}} <div class="aria-only">{{$_t('mongoid.errors.models.contact.aria_incomplete', {index: watchKey + 1})}}</div></div>
	<div aria-live="polite">{{asSentence}}</div>
	...
	<div class="contact-field">
		<div class="field-section narrow" role="radiogroup" :aria-label="radiogroupLabels.subject">
		...
		<div class="field-section narrow" role="radiogroup" :aria-label="radiogroupLabels.contact_type">
		...
		<div class="field-section narrow" role="radiogroup" :aria-label="radiogroupLabels.object">
		...
		<div class="field-section" role="radiogroup" :aria-label="radiogroupLabels.object_instrument">
		...
		<div class="field-section" role="radiogroup" :aria-label="radiogroupLabels.subject_instrument">
