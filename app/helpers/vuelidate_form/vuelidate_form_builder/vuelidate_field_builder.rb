...
module VuelidateForm; class VuelidateFormBuilder; class VuelidateFieldBuilder
																																																			...
																																																			def no_js_error_field
																																																				...
																																																				if @validate && @sub_error.present?
																																																					...
																																																					@template.content_tag(:noscript) do
																																																						@template.content_tag(:div, @sub_error,
																																																																												{ id: "#{@attribute}-error", class: 'field-errors' })
																																																					end
																																																				else
																																																					''
																																																				end
																																																			...
																																																			def call_after_method
																																																				...
																																																				return @template.send(@after_method,
																																																																										*@after_method_args) if @template.respond_to?(@after_method)
																																																			...
																																																			def input_options
																																																				...
																																																				defaults['v-model.lazy'] =
																																																					defaults.delete('v-model') if @options[:lazy]
																																																				defaults
																																																			end
																																																			...
																																																			def error_wrapper_options
																																																				...
																																																				nested_name = @object_name.respond_to?(:gsub) ? @object_name.gsub(
																																																					']', ''
																																																				).split('[') : [@object_name]
																																																				...
																																																				defaults[':$v'] =
																																																					"vf.$v.formData#{submission_error.gsub('submissionError',
                                                                                            '$v.formData')}"
																																																			...
																																																			def error_inner_options
																																																				...
																																																				defaults[:role] =
																																																					@options[:field_role] if @options.has_key? :field_role
																																																			...
																																																			def get_validation
																																																				...
																																																				@required = @options.has_key?(:required) ? @options[:required] : (@form_builder.options[:require_all] || filter_validators(
																																																					:presence, validators
																																																				))
																																																				...
																																																				if @validate
																																																					...
																																																					mapped_validators = VuelidateFormUtils.map_validators_for_form(
																																																						validators, @object, skip_validations
																																																					)
																																																					...
																																																					@form_builder.add_validation(@attribute,
																																																																																		mapped_validators) if mapped_validators.any?
																																																				end
